# DRuckli Scene Studies — Advanced Procedural Scene Nodes Analysis

Dissection of 16 advanced Scene Nodes scenes from DRuckli (motion-design
specialist). Each scene is a self-contained procedural tool — captured
here as both raw JSON dumps (`raw_dumps/`) and as a master vocabulary
...
Instead of generic "Nodes Modifier", DRuckli renames each container by
