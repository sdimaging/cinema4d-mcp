# DRuckli Deep-Study Record Schema

Every scene-study folder under `docs/druckli_studies/scenes/NN_<slug>/`
...
it will be hard to reuse."* The schema turns the DRuckli library into a
...
```jsonc
{
  ...
  "source_file": "Reaction_Diffusion_Tut-Files_01.c4d", // exact filename in DRuckli/
  "source_folder": "Reaction_Diffusion_Tut-Files_01",   // immediate parent folder name
...
Every committed scene appends one row to `docs/druckli_studies/INDEX.json`,
