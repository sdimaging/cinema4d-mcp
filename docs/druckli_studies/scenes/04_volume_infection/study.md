...
**Source:** `DRuckli/Volume-Infection_Tutorial_File_01/Volume-Infection_Tutorial_File_01.c4d`
**Studied:** 2026-05-01
...
5. **Visibility=2 on fresh load** is universal across DRuckli scenes — needs an auto-fix in load helpers.
